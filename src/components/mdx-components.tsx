...
const headingAliases: Record<string, string[]> = {
  ...
  '433-corpus-tests': ['corpus-tests', '394-corpus-tests'],
  '394-corpus-tests': ['corpus-tests', '433-corpus-tests'],
  ...
  '100-parity-node-modules': ['node-apis', 'nodejs-core-modules', 'parity-modules'],
  'nodejs-core-modules': ['node-apis', '100-parity-node-modules'],
  'web-standards-wintercg': ['wintercg'],
  'whatwg-fetch-and-formdata': ['fetch', 'formdata'],
  'whatwg-urlpattern': ['urlpattern'],
  ...
  'direct-execution--scg-alias': ['scg', 'direct-execution'],
